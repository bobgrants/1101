...
public class translateAscii : MonoBehaviour {

    public Text inputText;
    public Text resultText;
    string translateTemp;
    public gameManager gm;
    public timerCircle tm;
	...
	void Update () {
        ...
        if (inputText.text.Length == 8) {
            ...
            Debug.Log("8 first characters " + translateTemp);
